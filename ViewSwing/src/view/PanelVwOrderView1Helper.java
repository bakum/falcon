...
public class PanelVwOrderView1Helper extends JPanel implements JUPanel {

    //PageDefinition File	
    private JUPanelBinding panelBinding = new JUPanelBinding("view_PanelVwOrderView1HelperPageDef");
    private JPanel dataPanel = new JPanel();
    private BorderLayout borderLayout = new BorderLayout();

    private FormLayout panelLayout =
        new FormLayout("3dlu,d:g,3dlu,d:g,3dlu", "3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu,d,3dlu");
     ...
     */
    public PanelVwOrderView1Helper() {
    }
    ...
    public void jbInit() throws Exception {
        ...
        dataPanel.add(labelmMetrag, new CellConstraints("2 , 20 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mMetrag, new CellConstraints("4, 20 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmMontag, new CellConstraints("2 , 22 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mMontag, new CellConstraints("4, 22 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmNum, new CellConstraints("2 , 24 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mNum, new CellConstraints("4, 24 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmSumma, new CellConstraints("2 , 26 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mSumma, new CellConstraints("4, 26 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmTotal_Cost, new CellConstraints("2 , 28 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mTotal_Cost, new CellConstraints("4, 28 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmUserS, new CellConstraints("2 , 30 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mUserS, new CellConstraints("4, 30 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmZakSumm, new CellConstraints("2 , 32 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mZakSumm, new CellConstraints("4, 32 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(labelmZamer, new CellConstraints("2 , 34 ,1,1,default," + CellConstraints.FILL));
        dataPanel.add(mZamer, new CellConstraints("4, 34 ,1,1,default," + CellConstraints.FILL));
    ...
    public static void main(String[] args) {
        ...
        PanelVwOrderView1Helper panel = new PanelVwOrderView1Helper();
