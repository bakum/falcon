...
public class OrderQueryBean {
    ...
    public void onTableQueryExecuted(QueryEvent queryEvent) {
        FilterableQueryDescriptor des = (FilterableQueryDescriptor)getFeatureTable().getFilterModel();
        ...
        OperationBinding rangeStartOperationBinding = bindings.getOperationBinding("setf_dat");
        OperationBinding rangeEndOperationBinding = bindings.getOperationBinding("setl_dat");
        ...
        Object hireStartRange = map.get("f_dat");
        Object hireEndRange = map.get("l_dat");
        ...
        invokeMethod("#{bindings.VwOrderView1Query.processQuery}", QueryEvent.class, queryEvent);
        map.put("f_dat", hireStartRange);
        map.put("l_dat", hireEndRange);
